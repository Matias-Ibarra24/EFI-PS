...
class Entrada(db.Model):
    ...
    categorias = db.relationship('Categoria', secondary='entrada_categoria', lazy='subquery',backref=db.backref('entradas', lazy=True))
...
class Categoria(db.Model):
    ...
    entrada_categoria = db.Table('entrada_categoria',
